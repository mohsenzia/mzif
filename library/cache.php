...
class cacheMem {
    // Public OPTIONS
    // Can be set by Model_Cache::$option_name = $value|array|string
    ...
    public static $securityKey = "cache.storage"; // Model_Cache::$securityKey = "newKey";
    ...
    private static $supported_api = array("memcached","memcache","files","pdo","mpdo","apc","xcache","wincache");
